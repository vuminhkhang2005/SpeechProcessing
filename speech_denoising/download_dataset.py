...
def print_download_instructions():
    ...
    print()
    print("📥 BƯỚC 1: Download file dataset")
    print("-" * 40)
    print("   Download file: speech_denoising_data.zip")
    print()
    print("   File này chứa tất cả các thư mục cần thiết:")
    ...
    print()
    print("📂 BƯỚC 2: Giải nén vào thư mục data/")
    print("-" * 40)
    ...
    print("   └── noisy_testset_wav/          # 824 files")
    print()
    print("💻 BƯỚC 3: (Linux/Mac) Lệnh giải nén")
    print("-" * 40)
    print("   # Copy file zip vào thư mục speech_denoising/")
    print("   cp speech_denoising_data.zip speech_denoising/")
    print()
    print("   # Giải nén vào thư mục data/")
    print("   cd speech_denoising/")
    print("   unzip speech_denoising_data.zip -d data/")
    print()
    print("🔍 BƯỚC 4: Kiểm tra dataset")
    print("-" * 40)
